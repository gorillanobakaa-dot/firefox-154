...
TOOLS = "$HOME/Documents/Scripts.For.Work/searchfox-tools"
sys.path.insert(0, TOOLS)
import searchfox_tools as sf
import sfpref

CONFIG = "<repo>/config/firefox.js"
OUTDIR = os.path.dirname(os.path.abspath(__file__))
GREPREFS = "$HOME/firefox-src/obj-x86_64-pc-linux-gnu/dist/bin/greprefs.js"
LOCAL_FFJS = "$HOME/firefox-src/browser/app/profile/firefox.js"
