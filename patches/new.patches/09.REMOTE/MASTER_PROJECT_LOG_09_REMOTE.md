...
- Both patches reproduce the live tree byte-exact: staged vanilla
  ...
  `/home/gorilla/firefox-main` → `REMOTEAGENT: BYTE-EXACT MATCH`,
...
- **Technical:** remote_components_RemoteAgent.sys.mjs.patch: target path remote/components/RemoteAgent.sys.mjs	2026-08-03 12:43:46.381629057 +0100 is missing under /home/gorilla/firefox-main. The patch will not apply.
...
grep -n loopbackAddresses /home/gorilla/firefox-main/remote/components/RemoteAgent.sys.mjs   # ["127.0.0.1", "[::1]"] at :81
...
- live tree /home/gorilla/firefox-main
- patch(1), cmp
...
**Step 2:** cmp work/remote/components/RemoteAgent.sys.mjs /home/gorilla/firefox-main/remote/components/RemoteAgent.sys.mjs (and Marionette)
...
**Step 1:** grep -n loopbackAddresses /home/gorilla/firefox-main/remote/components/RemoteAgent.sys.mjs
