...
- **Restore:** `/home/gorilla/firefox-main` was incomplete (missing mach, browser/, dom/, netwerk/, intl/; objdir gutted). Restored from vanilla vault + Future.proof tarball + FIrefox.154.Look copies. Verified by preflight + build.
- **Roadblocks & fixes:**
