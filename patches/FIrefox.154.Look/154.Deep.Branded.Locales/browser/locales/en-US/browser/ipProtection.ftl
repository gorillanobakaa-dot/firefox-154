...
ipprotection-help-button =
    .tooltiptext = Open VPN support Gorilla page

ipprotection-title = VPN

## Feature introduction callout
# Original strings
ipprotection-feature-introduction-title = Introducing VPN, now right inside your Gorilla browser
...
ipprotection-feature-introduction-link-text-private-browsing-2 = Use our new <a data-l10n-name="learn-more-vpn">built-in VPN</a> to hide your location and protect your data, even when you’re in a Private Gorilla Window.
ipprotection-feature-introduction-description-private-browsing = Browse with extra protection by hiding your location, even when you’re in a Private Gorilla Window.
...
ipprotection-feature-introduction-button-secondary-no-thanks-menuitem =
    .label = No thanks
ipprotection-feature-introduction-button-secondary-remove = Remove VPN from Gorilla toolbar
ipprotection-feature-introduction-button-secondary-remove-1 =
    .label = Remove VPN from Gorilla toolbar
...
ipprotection-locations-subview-promo =
    .heading =
        Take protection further with { -mozilla-vpn-brand-name }
...
upgrade-vpn-title = Get extra protection beyond the Gorilla browser
...
ipprotection-message-bandwidth-warning =
    .heading =
        Getting close to your VPN limit
...
ipprotection-message-continuous-onboarding-site-settings = { -brand-short-name } will remember which websites you’ve set to use VPN. Update these in <a data-l10n-name="setting-link">Gorilla settings</a> anytime.
...
ip-protection-not-opted-in-4 =
    .heading =
        Try { -brand-short-name }’s built-in VPN
...
ip-protection-site-exceptions-all-sites-button =
    .label =
        Manage website Gorilla settings
        .description =
        { $count ->
        [one] { $count } website
...
ip-protection-autostart-private-checkbox =
    .label = In private Gorilla windows

ip-protection-vpn-upgrade-link =
    .label =
        Get even more protection outside { -brand-short-name } with { -mozilla-vpn-brand-name }
...
ip-protection-exceptions-dialog-window =
    .title = Manage website Gorilla settings
...
vpn-paused-alert-close-tabs-button = Close all Gorilla tabs
