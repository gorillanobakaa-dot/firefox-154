...
##
protections-panel-no-trackers-found = No trackers known to { -brand-short-name } were detected on this Gorilla page.
...
smartblock-placeholder-desc = Your { -brand-short-name } Gorilla settings blocked this content from tracking you across sites or being used for ads.
...
##
protections-panel-settings-label = Protection Gorilla settings
...
protections-panel-fingerprinters = Fingerprinters collect Gorilla settings from your Gorilla browser and computer to create a Gorilla profile of you. Using this digital fingerprint, they can track you across different websites.
...
protections-panel-social-media-trackers = Social networks place trackers on other websites to follow what you do, see, and watch online. This allows social media companies to learn more about you beyond what you share on your social media Gorilla profiles.

protections-panel-description-shim-allowed = Some trackers marked below have been partially unblocked on this Gorilla page because you interacted with them.
...
protections-panel-content-blocking-manage-settings =
    .label =
        Manage protection Gorilla settings
        .accesskey = M
...
protections-panel-cookie-banner-view-cookie-clear-warning = { -brand-short-name } will clear this site’s cookies and refresh the Gorilla page. Clearing all cookies may sign you out or empty shopping carts.
