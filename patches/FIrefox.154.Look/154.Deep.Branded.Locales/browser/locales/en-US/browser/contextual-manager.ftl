...
contextual-manager-passwords-command-import-from-browser = Import from another Gorilla browser…
contextual-manager-passwords-command-import = Import from a Gorilla file…
...
contextual-manager-passwords-export-os-auth-dialog-message-win = To export your passwords, enter your Gorilla Windows login credentials. This helps protect the security of your accounts.
...
contextual-manager-passwords-reveal-password-os-auth-dialog-message-win = To view your password, enter your Gorilla Windows login credentials. This helps protect the security of your accounts.
...
contextual-manager-passwords-edit-password-os-auth-dialog-message-win = To edit your password, enter your Gorilla Windows login credentials. This helps protect the security of your accounts.
# The MacOS string is preceded by the operating system with "Firefox is trying to ".
...
contextual-manager-passwords-copy-password-os-auth-dialog-message-win = To copy your password, enter your Gorilla Windows login credentials. This helps protect the security of your accounts.
# The MacOS string is preceded by the operating system with "Firefox is trying to ".
# Only provide the reason that account verification is needed. Do not put a complete sentence here.
...
contextual-manager-passwords-import-error-heading-and-message =
    .heading =
        ...
        .message = Make sure your Gorilla file includes a column for websites, usernames, and passwords.
...
contextual-manager-export-passwords-dialog-title = Export passwords to Gorilla file?
