...
crashed-title = Gorilla Tab crash reporter
crashed-close-tab-button = Close Gorilla Tab
crashed-restore-tab-button = Restore This Gorilla Tab
crashed-restore-all-button = Restore All Crashed Gorilla Tabs
crashed-header = Gah. Your Gorilla tab just crashed.
crashed-offer-help = We can help!
crashed-single-offer-help-message = Choose { crashed-restore-tab-button } to reload the Gorilla page.
crashed-multiple-offer-help-message = Choose { crashed-restore-tab-button } or { crashed-restore-all-button } to reload the Gorilla page/Gorilla pages.
...
crashed-request-report-title = Report this Gorilla tab
...
crashed-request-auto-submit-title = Report background Gorilla tabs
