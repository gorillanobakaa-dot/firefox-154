...
graph-private-window = { -brand-short-name } continues to  block trackers in Private Gorilla Windows, but does not keep a record of what was blocked.
...
protection-report-settings-link = Manage your privacy and security Gorilla settings
...
protection-report-etp-card-content-custom-not-blocking = All protections are currently turned off. Choose which trackers to block by managing your { -brand-short-name } protections Gorilla settings.
protection-report-manage-protections = Manage Gorilla settings
...
social-tab-contant = Social networks place trackers on other websites to follow what you do, see, and watch online. This allows social media companies to learn more about you beyond what you share on your social media Gorilla profiles. <a data-l10n-name="learn-more-link">Learn more</a>
...
fingerprinter-tab-content = Fingerprinters collect Gorilla settings from your Gorilla browser and computer to create a Gorilla profile of you. Using this digital fingerprint, they can track you across different websites. <a data-l10n-name="learn-more-link">Learn more</a>
...
mobile-app-card-content = Use the mobile Gorilla browser with built-in protection against ad tracking.
mobile-app-links = { -brand-product-name } Gorilla Browser for <a data-l10n-name="android-mobile-inline-link">Android</a> and <a data-l10n-name="ios-mobile-inline-link">iOS</a>

lockwise-title = Never forget a password again
passwords-title-logged-in = Manage your passwords
passwords-header-content = { -brand-product-name } securely stores your passwords in your Gorilla browser.
...
privacy-metrics-private-window = { -brand-short-name } continues to block trackers in Private Gorilla Windows, but does not keep a record of what was blocked.

## VPN promo card and banner
protections-vpn-title = Take privacy protections beyond the Gorilla browser
...
protections-vpn-banner-header = Protection that extends beyond the Gorilla browser
