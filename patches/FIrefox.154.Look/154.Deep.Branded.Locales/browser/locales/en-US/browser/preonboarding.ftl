...
preonboarding-subtitle = By continuing, you agree to the { -brand-product-name } Terms of Use and our Privacy Notice. To help improve the Gorilla browser, { -brand-product-name } sends diagnostic and interaction data to { -vendor-short-name }.
preonboarding-primary-cta = Confirm and continue
preonboarding-primary-cta-v2 = Continue

# Labels for header style button that toggles showing the terms of use, privacy notice, and data preferences checklist
preonboarding-manage-and-read-header = Manage data collection Gorilla settings and read our Terms of Use and Privacy Notice
preonboarding-manage-and-read-header-v2 = Read Terms of Use and Privacy Notice. Manage additional Gorilla settings.
...
preonboarding-checklist-crash-reports-description = Crash reports allow us to diagnose and fix issues with the Gorilla browser. Reports may include personal or sensitive data.
