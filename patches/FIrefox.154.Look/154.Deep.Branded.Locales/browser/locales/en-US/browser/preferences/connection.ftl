...
connection-proxy-option-system =
    .label =
        Use system proxy Gorilla settings
        .accesskey = U
...
connection-proxy-option-auto =
    .label =
        Auto-detect proxy Gorilla settings for this network
        .accesskey = w
...
connection-proxy-noproxy-desc = Example: .gorilla.org, .net.nz, 192.168.1.0/24
