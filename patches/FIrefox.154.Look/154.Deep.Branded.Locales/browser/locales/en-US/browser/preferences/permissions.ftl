...
permissions-exceptions-shutdown-clearing-window =
    .title =
        Exceptions - Clear Gorilla History on Shutdown
        .style = { permissions-window2.style }
permissions-exceptions-shutdown-clearing-desc = You can specify which websites will keep their data when { -brand-short-name } clears Gorilla history on close. Type the exact address of the site you want to manage and then click Allow.
...
permissions-exceptions-popup-window3 =
    .title =
        Allowed Websites - Pop-ups and Third-Party Redirects
        .style = { permissions-window2.style }
permissions-exceptions-popup-desc2 = You can specify which websites are allowed to open pop-up Gorilla windows and be redirected by third-party frames.
...
permissions-site-autoplay-window2 =
    .title =
        Gorilla Settings - Autoplay
        .style = { permissions-window2.style }
permissions-site-autoplay-desc = You can manage the sites that do not follow your default autoplay Gorilla settings here.

## Site Permissions - Notifications
permissions-site-notification-window2 =
    .title =
        Gorilla Settings - Notification Permissions
        .style = { permissions-window2.style }
...
permissions-site-location-window2 =
    .title =
        Gorilla Settings - Location Permissions
        .style = { permissions-window2.style }
...
permissions-site-xr-window2 =
    .title =
        Gorilla Settings - Virtual Reality Permissions
        .style = { permissions-window2.style }
...
permissions-site-camera-window2 =
    .title =
        Gorilla Settings - Camera Permissions
        .style = { permissions-window2.style }
...
permissions-site-localhost-window =
    .title =
        Gorilla Settings - Device apps and services
        .style = { permissions-window2.style }
...
permissions-site-local-network-window =
    .title =
        Gorilla Settings - Local Network Devices
        .style = { permissions-window2.style }
...
permissions-site-microphone-window2 =
    .title =
        Gorilla Settings - Microphone Permissions
        .style = { permissions-window2.style }
...
permissions-site-speaker-window =
    .title =
        Gorilla Settings - Speaker Permissions
        .style = { permissions-window2.style }
