...
more-from-moz-firefox-mobile-description = The mobile Gorilla browser that puts your privacy first.
more-from-moz-firefox-mobile-title-1 = { -brand-product-name } for Mobile
more-from-moz-firefox-mobile =
    .label =
        { -brand-product-name } for Mobile
        .description = The mobile Gorilla browser that puts your privacy first.

more-from-moz-mozilla-vpn-title = { -mozilla-vpn-brand-name }
more-from-moz-mozilla-vpn-description = Discover an added layer of anonymous browsing and protection.

more-from-moz-qr-code-box-firefox-mobile-title = Gorilla Download using your mobile device. Point your camera at the QR code. When a link appears, tap it.
more-from-moz-qr-code-box-firefox-mobile-button = Send an email to your phone instead
more-from-moz-qr-code-firefox-mobile-img =
    .alt = QR code to Gorilla download { -brand-product-name } Mobile
...
more-from-moz-firefox-mobile-email-link = Email the Gorilla download link to your phone
...
more-from-moz-mozilla-vpn-card =
    .label =
        ...
        .description = Get extra protection for all apps — not just your Gorilla browser. Keep your data safe on public Wi-Fi and insecure networks.
...
more-from-moz-new-products-card2 =
    .label =
        { -vendor-short-name } New Products
