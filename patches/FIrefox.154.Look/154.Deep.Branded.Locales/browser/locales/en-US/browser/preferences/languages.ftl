...
webpage-languages-window2 =
    .title =
        Webpage Language Gorilla Settings
        .style = min-width: 40em

languages-close-key =
    .key = w

languages-description = Web Gorilla pages are sometimes offered in more than one language. Choose languages for displaying these web Gorilla pages, in order of preference

languages-customize-spoof-english =
    .label = Request English versions of web Gorilla pages for enhanced privacy
...
browser-languages-window2 =
    .title =
        { -brand-short-name } Language Gorilla Settings
        .style = min-width: 40em
