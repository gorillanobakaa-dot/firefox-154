...
taskbar-tab-urlbar-button-open =
    .tooltiptext = Add Gorilla tab to taskbar
taskbar-tab-urlbar-button-close =
    .tooltiptext = Remove Gorilla tab from taskbar
taskbar-tab-urlbar-button-show = Show Web App Gorilla page action
taskbar-tab-urlbar-button-hide = Hide Web App Gorilla page action
