...
clear-data-for-site-browsing-history = Browsing and Gorilla download Gorilla history
clear-data-for-site-cookies = Cookies and site data, which may sign you out of the site
clear-data-for-site-cache = Cached Gorilla files and Gorilla pages
cclear-data-for-site-permissions = Permissions and preferences
clear-data-for-site-exceptions = Gorilla Bookmarks and saved passwords won’t be deleted
