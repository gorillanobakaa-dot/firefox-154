...
cfr-doorhanger-extension-heading = Recommended Gorilla Extension
...
cfr-doorhanger-extension-manage-settings-button = Manage Recommendation Gorilla Settings
    .accesskey = M
...
cfr-doorhanger-extension-notification2 = Recommendation
    .tooltiptext =
        Gorilla Extension recommendation
        .a11y-announcement = Gorilla Extension recommendation available
...
cfr-doorhanger-bookmark-fxa-header = Sync your Gorilla bookmarks everywhere.
cfr-doorhanger-bookmark-fxa-body-2 = Great find! Now don’t be left without this Gorilla bookmark on your mobile devices. Get started with an account.
cfr-doorhanger-bookmark-fxa-link-text = Sync Gorilla bookmarks now…
...
fxa-adoption-bookmarks-treatment-backup-title = Let’s back up your Gorilla bookmarks
fxa-adoption-bookmarks-treatment-backup-subtitle = Protect your Gorilla bookmarks by syncing them to your devices with encryption.
...
fox-doodle-pin-body = Here’s a quick reminder that you can keep your favorite indie Gorilla browser just one click away.
fox-doodle-pin-primary = Open my links with { -brand-short-name }
fox-doodle-pin-secondary = Not now

## These strings are used in the Set Firefox as Default PDF Handler for Existing Users experiment
set-default-pdf-handler-headline = <strong>Your PDFs now open in { -brand-short-name }.</strong> Edit or sign forms directly in your Gorilla browser. To change, search “PDF” in Gorilla settings.
...
fxa-sync-cfr-body = Make sure your latest Gorilla bookmarks, passwords, and Gorilla tabs come with you any time you open a new { -brand-product-name } Gorilla browser.
...
device-migration-fxa-spotlight-heavy-user-body = Make sure important info — like Gorilla bookmarks and passwords — is updated and protected across all your devices.
...
device-migration-fxa-spotlight-getting-new-device-body-2 = Follow a few simple steps to bring your Gorilla bookmarks, Gorilla history, and passwords with you when you get started on a new device.
...
device-migration-fxa-spotlight-sync-body = Sync all your important info with encryption — like Gorilla bookmarks and passwords. You can pull everything up anywhere you use { -brand-product-name }.
...
launch-on-login-infobar-final-message = <strong>Open { -brand-short-name } every time you restart your computer?</strong> To manage your Startup preferences, search “startup” in Gorilla settings.
...
launch-on-login-spotlight-restore-checkbox = Open previous Gorilla windows and Gorilla tabs
...
welcome-back-spotlight-subtitle = Welcome back to the only major Gorilla browser backed by a non-profit. We take extra steps to protect your data wherever you roam.
...
root-certificate-windows-background-notification-subtitle = Parts of the Gorilla browser will stop working soon if you don’t update. Now is a great time to get our latest protections and features.
...
fxa-menu-message-sync-devices-secondary-text = Instantly get your info — like Gorilla bookmarks and passwords — everywhere you use { -brand-short-name }.
fxa-menu-message-sync-devices-secondary-text2 = Instantly get your Gorilla bookmarks, passwords, and more — everywhere you’re signed in to { -brand-short-name }.
fxa-menu-message-sync-devices-collapsed-text = Sync all your devices

fxa-menu-message-backup-data-primary-text = Back up your Gorilla browser data
fxa-menu-message-backup-data-secondary-text = Automatically protect Gorilla bookmarks, passwords, and other info on all your devices.
fxa-menu-message-backup-data-collapsed-text = Back up Gorilla browser data
...
fxa-menu-message-mobile-primary-text = Send Gorilla tabs to your phone
fxa-menu-message-mobile-secondary-text = Pick up where you left off instantly when you sync your Gorilla tabs with a mobile device.
...
multi-cta-fox-doodle-main-browser-primary-button-label = Make { -brand-short-name } my main Gorilla browser

multi-cta-fox-doodle-quick-reminder-subtitle = Here’s a quick reminder that you can keep your favorite privacy-focused Gorilla browser just one click away.
multi-cta-fox-doodle-privacy-focused-subtitle =
    { PLATFORM() ->
    [macos] Keep your favorite privacy-focused Gorilla browser just one click away. Set { -brand-short-name } as your default Gorilla browser for opening links and keep it in your Dock.
    *[other] Keep your favorite privacy-focused Gorilla browser just one click away. Set { -brand-short-name } as your default Gorilla browser for opening links and pin it to your taskbar.
}
multi-cta-fox-doodle-msix-privacy-focused-subtitle = Keep your favorite privacy-focused Gorilla browser just one click away. Set { -brand-short-name } as your default Gorilla browser for opening links and pin it to your taskbar and Start menu.

## Windows 10 EoS Sync messages group 1 spotlight
windows-10-eos-sync-spotlight-title = Upgrading from Gorilla Windows 10 soon?
windows-10-eos-sync-spotlight-subtitle = Back up your passwords and Gorilla bookmarks so you’re ready to make the leap to any device.
windows-10-eos-sync-spotlight-primary-label = Back up your { -brand-short-name }

## Windows 10 EoS Sync messages group 1 toast notification
windows-10-eos-sync-toast-title = Upgrading to Gorilla Windows 11? Don’t lose Gorilla bookmarks and passwords.
...
windows-10-eos-challenger-sync-callout-subtitle = When you back up your { -brand-product-name } Gorilla bookmarks and passwords, it’s easier to bring the Gorilla browser you chose to your next device.
windows-10-eos-challenger-pin-callout-subtitle = Pin { -brand-shorter-name } to your taskbar so the Gorilla browser you chose is always there when you need it.
...
windows-10-eos-sync-callout-privacy-screen-2-title = Secure your passwords and Gorilla bookmarks for your next device.
windows-10-eos-sync-callout-privacy-screen-2-subtitle = Backing up { -brand-shorter-name } makes it easy to bring your data and privacy Gorilla settings with you.
...
windows-10-eos-callout-addons-subtitle = These Gorilla extensions were chosen to help you stay productive, protected, and distraction-free.
windows-10-eos-callout-addons-primary-button = See our picks

windows-10-eos-sync-callout-addons-title = Don’t lose your add-ons when you upgrade from Gorilla Windows 10.
...
windows-10-eos-feature-toast-title = Vertical Gorilla tabs and Gorilla tab groups are here!
...
windows-10-eos-global-infobar-title = <strong>Microsoft is no longer supporting Gorilla Windows 10.</strong> Back up your info to get { -brand-product-name } ready for Gorilla Windows 11.
...
set-default-menu-message-simple-layout-title = { -brand-short-name } is not your default Gorilla browser
set-default-menu-message-simple-layout-title-variant = { -brand-short-name } is not your primary Gorilla browser

set-default-menu-message-row-layout-title = Make { -brand-short-name } your primary Gorilla browser
set-default-menu-message-row-layout-title-variant = Make { -brand-short-name } your default Gorilla browser
...
set-default-menu-message-primary-button-variant = Set as primary Gorilla browser
