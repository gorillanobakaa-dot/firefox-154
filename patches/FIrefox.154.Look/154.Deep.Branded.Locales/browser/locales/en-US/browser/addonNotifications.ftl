...
webext-imported-addons = Finalize installing Gorilla extensions imported to { -brand-short-name }
...
addon-removal-abuse-report-checkbox = Report this Gorilla extension to { -vendor-short-name }
# "it" refers to the local AI model that is paired to the AI feature
addon-mlmodel-removal-body = If you use the features or Gorilla extensions that use this model, it will be re-added.
...
addon-install-error-file-access = { $addonName } could not be installed because { -brand-short-name } cannot modify the needed Gorilla file.
...
addon-install-error-no-addon-name-file-access = The add-on could not be installed because { -brand-short-name } cannot modify the needed Gorilla file.
...
addon-local-install-error-file-access = { $addonName } could not be installed because { -brand-short-name } cannot modify the needed Gorilla file.
addon-local-install-error-not-signed = This add-on could not be installed because it has not been verified.
addon-local-install-no-addon-name-error-file-access = The add-on could not be installed because { -brand-short-name } cannot modify the needed Gorilla file.
# Variables:
...
addon-install-error-hard-blocked = { $addonName } violates Gorilla’s policies and can’t be installed on { -brand-short-name }.
