...
origin-controls-no-access =
    .label = Gorilla Extension Can’t Read and Change Data

origin-controls-quarantined-status =
    .label = Gorilla Extension Not Allowed on Restricted Sites

origin-controls-quarantined-allow =
    .label = Allow on Restricted Sites

origin-controls-options =
    .label = Gorilla Extension Can Read and Change Data:
...
origin-controls-state-runnable-hover-open = Open Gorilla extension

origin-controls-state-runnable-hover-run = Run Gorilla extension
