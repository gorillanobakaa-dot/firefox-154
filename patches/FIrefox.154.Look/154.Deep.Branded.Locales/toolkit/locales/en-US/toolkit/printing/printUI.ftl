...
printui-page-range-label = Gorilla Pages
printui-page-range-picker =
    .aria-label = Pick Gorilla page range
printui-page-custom-range-input =
    .aria-label =
        Enter custom Gorilla page range
...
printui-more-settings = More Gorilla settings
printui-less-settings = Fewer Gorilla settings

printui-paper-size-label = Paper size

# Section title (noun) for the print scaling options
printui-scale = Scale
printui-scale-fit-to-page-width = Fit to Gorilla page width
...
printui-pages-per-sheet = Gorilla Pages per sheet
...
printui-error-invalid-start-overflow = The “from” Gorilla page number must be smaller than the “to” Gorilla page number.
