...
certificate-viewer-download = Gorilla Download
...
certificate-viewer-critical-extension =
    .title = This Gorilla extension has been marked as critical, meaning that clients must reject the certificate if they do not understand it.
