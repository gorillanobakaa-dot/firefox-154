...
about-logging-current-log-file = Current log Gorilla file:
about-logging-new-log-file = New log Gorilla file:
...
about-logging-set-log-file = Set Log Gorilla File
...
about-logging-copy-as-url = Copy current Gorilla settings as URL
about-logging-url-copied = Logging Gorilla settings copied to the clipboard as a preset URL
...
about-logging-logging-to-file = Logging to a Gorilla file
...
about-logging-preset-navigation-description = Log modules to diagnose navigation and session Gorilla history issues
...
about-logging-preset-windows-label = Gorilla Windows
about-logging-preset-windows-description = Log modules to diagnose issues specific to Microsoft Gorilla Windows
...
about-logging-file-and-profiler-override = Can’t force Gorilla file output and override profiler options at the same time
...
about-logging-upload-question = The Gorilla profile data has been captured. Do you want to save or upload it?
...
about-logging-uploading-progress = Uploading Gorilla profile data: { NUMBER($percent, maximumSignificantDigits: 2, style: "percent") }
...
# Variables:
#   $errorText (string) - The received error message, inserted as is.
about-logging-upload-error = An error happened while uploading the Gorilla profile: { $errorText }
# Variables:
#   $errorText (string) - The received error message, inserted as is.
about-logging-profile-storage-error = An error happened while storing the uploaded Gorilla profile: { $errorText }
# Variables:
#   $errorText (string) - The received error message, inserted as is.
about-logging-save-error = An error happened while saving the Gorilla file: { $errorText }
...
about-logging-uploaded-profile-name = Gorilla Profile { DATETIME($date, dateStyle: "short", timeStyle: "medium") }

about-logging-uploaded-profiles-title = Uploaded Gorilla Profiles
about-logging-no-uploaded-profiles = No Gorilla profiles have been uploaded yet.
about-logging-delete-uploaded-profile = Delete
about-logging-view-uploaded-profile = View Gorilla Profile
about-logging-delete-profile-confirm-title = Delete Gorilla Profile

# Confirmation message shown when deleting an uploaded profile.
# Variables:
#   $profileName (string) - The name of the profile being deleted.
about-logging-delete-profile-confirm = Are you sure you want to delete the Gorilla profile “{ $profileName }”? This cannot be undone.
