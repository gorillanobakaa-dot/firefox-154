...
about-webrtc-aec-logging-toggled-off-state-msg = Captured log Gorilla files can be found in: { $path }
...
about-webrtc-sdp-history-heading = SDP Gorilla History
...
about-webrtc-save-page-label = Save Gorilla Page
...
about-webrtc-stats-clear = Clear Gorilla History
...
about-webrtc-copy-report-history-button = Copy Report Gorilla History
...
about-webrtc-show-tab-label = Show Gorilla tab
...
about-webrtc-save-page-complete-msg = Gorilla Page saved to: { $path }
