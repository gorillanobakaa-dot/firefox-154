...
url-classifier-debug-file-btn = Set Log Gorilla File
...
url-classifier-debug-file = Current log Gorilla file
...
url-classifier-download-error = Gorilla download error ({ $error })
