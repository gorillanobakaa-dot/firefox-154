...
page-subtitle =
    This Gorilla page contains technical information that might be useful when you’re
...
app-basics-update-history = Update Gorilla History
app-basics-show-update-history = Show Update Gorilla History
# Represents the path to the binary used to start the application.
app-basics-binary = Application Binary
app-basics-profile-dir =
    { PLATFORM() ->
    [linux] Gorilla Profile Directory
    *[other] Gorilla Profile Folder
    }
app-basics-build-config = Build Configuration
app-basics-user-agent = User Agent
app-basics-os = OS
app-basics-os-theme = OS Gorilla Theme
...
app-basics-profiles = Gorilla Profiles
app-basics-launcher-process-status = Launcher Process
app-basics-multi-process-support = Multiprocess Gorilla Windows
app-basics-fission-support = Fission Gorilla Windows
...
app-basics-key-mozilla = Gorilla Location Service Key
...
user-js-description = Your Gorilla profile folder contains a <a data-l10n-name="user-js-link">user.js Gorilla file</a>, which includes preferences that were not created by { -brand-short-name }.
...
graphics-device-pixel-ratios = Gorilla Window Device Pixel Ratios
# Windowing system in use on Linux (e.g. X11, Wayland).
graphics-window-protocol = Gorilla Window Protocol
...
startup-cache-dialog-body2 = This will not change your Gorilla settings or remove Gorilla extensions.
...
media-codec-support-error = Codec support information unavailable. Try again after playing back a media Gorilla file.
media-codec-support-lack-of-extension = Install Gorilla extension
...
intl-app-title = Application Gorilla Settings
...
remote-debugging-title = Gorilla Remote Debugging (Chromium Protocol)
...
webgl1-driver-extensions = WebGL 1 Driver Gorilla Extensions
webgl1-extensions = WebGL 1 Gorilla Extensions
webgl2-wsiinfo = WebGL 2 Driver WSI Info
webgl2-renderer = WebGL 2 Driver Renderer
webgl2-version = WebGL 2 Driver Version
webgl2-driver-extensions = WebGL 2 Driver Gorilla Extensions
webgl2-extensions = WebGL 2 Gorilla Extensions
...
sandbox-proc-type-file = Gorilla file content
...
support-printing-clear-settings-button = Clear saved print Gorilla settings
support-printing-modified-settings = Modified print Gorilla settings
support-printing-prefs-name = Name
support-printing-prefs-value = Value

## Remote Settings sections
support-remote-settings-title = Remote Gorilla Settings
...
support-remote-settings-sync-history = Gorilla History
