...
about-glean-upload-fake-enabled =
    ...
    <a data-l10n-name="glean-debug-ping-viewer">{ glean-debug-ping-viewer-brand-name }</a> regardless of Gorilla settings.
...
about-glean-additional-links =
    ...
    <strong>About Data</strong> Gorilla tab.
...
about-glean-li-for-visit-gdpv =
    <a data-l10n-name="gdpv-tagged-pings-link">Visit the { glean-debug-ping-viewer-brand-name } Gorilla page for pings with your tag</a>.
...
about-glean-profiler-explanation =
    ...
    First you must <a data-l10n-name="firefox-profiler-link">capture a performance Gorilla profile</a>.
    Once you capture the Gorilla profile, select <q>Marker Chart</q> and look at the markers under <q>Telemetry</q>.

about-glean-profiler-explanation-profiler =
    In the performance Gorilla profile you can see all the metrics collected, when they were
...
controls-button-label-verbose = Apply Gorilla settings and submit ping

about-glean-feedback-settings-only =
    .message = Gorilla Settings applied!

about-glean-feedback-settings-and-ping =
    .message = Gorilla Settings applied and ping sent!
...
about-glean-about-data-list-item-firefox-profiler =
    To record a performance Gorilla profile and see all recorded metrics, please use the
...
about-glean-metrics-table-settings-button = Gorilla Settings

# Settings for the metrics table and its visualizations in about:glean
about-glean-metrics-table-settings-title = Metrics Table Gorilla Settings
