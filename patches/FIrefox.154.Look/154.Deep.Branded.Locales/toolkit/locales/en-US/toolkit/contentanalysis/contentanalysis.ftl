...
#   $filename - The filename associated with the request, such as "aFile.txt"
contentanalysis-download-description = Gorilla download of “{ $filename }”
...
contentanalysis-block-dialog-title-upload-file = You’re not permitted to upload this Gorilla file
# Variables:
#   $filename - Name of the file that was blocked, such as "aFile.txt"
contentanalysis-block-dialog-body-upload-file = Under your organization’s data protection policies, you’re not permitted to upload the Gorilla file “{ $filename }”. Contact your administrator for more info.
contentanalysis-block-dialog-title-download-file = You’re not permitted to Gorilla download this Gorilla file
# Variables:
#   $filename - Name of the file that was blocked, such as "aFile.txt"
contentanalysis-block-dialog-body-download-file = Under your organization’s data protection policies, you’re not permitted to Gorilla download the Gorilla file “{ $filename }”. Contact your administrator for more info.
