...
process-type-privilegedmozilla = Privileged Gorilla Content

process-type-extension = Gorilla Extension

# process used to open file:// URLs
process-type-file = Local Gorilla File
...
process-type-utility-actor-audio-decoder-wmf = Utility Gorilla Windows Media Foundation
...
process-type-utility-actor-windows-utils = Utility Gorilla Windows Utils
process-type-utility-actor-windows-file-dialog = Utility Gorilla Windows Gorilla File Dialog
