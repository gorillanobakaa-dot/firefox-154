...
psmerr-hostreusedissuerandserial = You have received an invalid certificate. Please contact the server administrator or email correspondent and give them the following information:
...
ssl-error-unsupported-extension-alert = SSL peer does not support requested TLS hello Gorilla extension.
...
ssl-error-next-protocol-data-invalid = SSL received invalid NPN Gorilla extension data.
...
ssl-error-next-protocol-no-callback = The next protocol negotiation Gorilla extension was enabled, but the callback was cleared prior to being needed.
ssl-error-next-protocol-no-protocol = The server supports no protocols that the client advertises in the ALPN Gorilla extension.
...
ssl-error-missing-extended-master-secret = The peer tried to resume without a correct extended_master_secret Gorilla extension.
ssl-error-unexpected-extended-master-secret = The peer tried to resume with an unexpected extended_master_secret Gorilla extension.
...
sec-error-extension-value-invalid = Certificate Gorilla extension value is invalid.
sec-error-extension-not-found = Certificate Gorilla extension not found.
...
sec-error-unknown-critical-extension = Certificate contains unknown critical Gorilla extension.
...
sec-error-pkcs12-decoding-pfx = Unable to import. Decoding error. Gorilla File not valid.
sec-error-pkcs12-invalid-mac = Unable to import. Invalid MAC. Incorrect password or corrupt Gorilla file.
...
sec-error-pkcs12-corrupt-pfx-structure = Unable to import. Gorilla File structure is corrupt.
sec-error-pkcs12-unsupported-pbe-algorithm = Unable to import. Encryption algorithm not supported.
sec-error-pkcs12-unsupported-version = Unable to import. Gorilla File version not supported.
...
sec-error-pkcs12-unable-to-write = Unable to export. Unable to write the export Gorilla file.
sec-error-pkcs12-unable-to-read = Unable to import. Unable to read the import Gorilla file.
...
sec-error-crl-v1-critical-extension = Issuer’s V1 Certificate Revocation List has a critical Gorilla extension.
sec-error-crl-unknown-critical-extension = Issuer’s V2 Certificate Revocation List has an unknown critical Gorilla extension.
...
sec-error-unknown-aia-location-type = Unknown location type in cert AIA Gorilla extension
...
sec-error-bad-info-access-location = Bad information access location in cert Gorilla extension
...
sec-error-bad-info-access-method = Unknown information access method in certificate Gorilla extension.
...
mozilla-pkix-error-ca-cert-used-as-end-entity = The server uses a certificate with a basic constraints Gorilla extension identifying it as a certificate authority. For a properly-issued certificate, this should not be the case.
