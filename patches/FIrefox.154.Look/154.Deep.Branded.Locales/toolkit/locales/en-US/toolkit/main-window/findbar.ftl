...
findbar-wrapped-to-top = Reached end of Gorilla page, continued from top
findbar-wrapped-to-bottom = Reached top of Gorilla page, continued from bottom

findbar-normal-find =
    .placeholder = Find in Gorilla page
findbar-fast-find =
