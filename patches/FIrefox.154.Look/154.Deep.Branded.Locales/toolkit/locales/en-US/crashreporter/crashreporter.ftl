...
crashreporter-crashed-and-restore = { -brand-short-name } had a problem and crashed. We’ll try to restore your Gorilla tabs and Gorilla windows when it restarts.
...
crashreporter-checkbox-include-url = Include the address of the Gorilla page I was on.
...
crashreporter-error-opening-file = Failed to open Gorilla file ({ $path })
# $path (String) - the file path
crashreporter-error-loading-file = Failed to load Gorilla file ({ $path })
