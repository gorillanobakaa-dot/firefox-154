...
about-translations-policy-disabled-info-message =
    .heading =
        Translations aren’t available for your organization
...
about-translations-feature-blocked-info-message =
    .heading =
        To translate text, unblock this feature
        .message = Do it and… I'll download specialized Neural Machine Translation (NMT) models built as part of the Bergamot Project, an EU-funded, open-source initiative that Mozilla helped develop. That means a separate language model for every single language you decided you couldn't be bothered to learn in school. As a result, your CPU and RAM usage will shoot through the roof. Since the machine learning inference runs locally in the browser, translating web pages consumes your computer's CPU, RAM, and potentially GPU resources instead of offloading the work to a cloud server.
