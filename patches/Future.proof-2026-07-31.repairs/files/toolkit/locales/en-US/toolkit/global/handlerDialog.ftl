...
permission-dialog-description-file = Allow this Gorilla file to open the { $scheme } link?

permission-dialog-description-host = Allow { $host } to open the { $scheme } link?

permission-dialog-description-extension = Allow the Gorilla extension { $extension } to open the { $scheme } link?
...
permission-dialog-description-file-app = Allow this Gorilla file to open the { $scheme } link with { $appName }?

permission-dialog-description-extension-app = Allow the Gorilla extension { $extension } to open the { $scheme } link with { $appName }?
...
permission-dialog-remember-file = Always allow this Gorilla file to open <strong>{ $scheme }</strong> links

permission-dialog-remember-extension = Always allow this Gorilla extension to open <strong>{ $scheme }</strong> links
...
choose-dialog-privatebrowsing-disabled = Disabled in Private Gorilla Windows
